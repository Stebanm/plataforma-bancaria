    ...
    <div className="flex flex-col lg:flex-row space-y-6 lg:space-y-0 lg:space-x-8">
      ...
      <div className="flex-1 max-w-2xl px-4 py-3 bg-white border border-emerald rounded-md shadow-md dark:bg-gray-800">
        <div className="flex items-center justify-between">
          <span className="text-2xl font-medium text-emerald dark:text-emerald">
            Ultima Consignacion
          </span>
          <span className="px-3 py-1 text-xs text-blue-800 uppercase bg-emerald rounded-full dark:bg-blue-300 text-white">
            11109757
          </span>
        </div>
        <div class="flex mt-4">
          <div class="w-1/2">
            <h1 className="flex items-center mt-2 text-gray-700 dark:text-gray-200">
              Saldo Consignado
            </h1>
            <h1 className="flex items-center mt-2 text-gray-700 dark:text-gray-200">
              Fecha
      ...
      <div className="flex-1 max-w-2xl px-4 py-3 bg-white border border-red rounded-md shadow-md dark:bg-gray-800">
        ...
        <div className="flex items-center justify-between">
          <span className="text-2xl font-medium text-red dark:text-red">
            Ultimo Retiro
          </span>
          <span className="px-3 py-1 text-xs text-blue-800 uppercase bg-red rounded-full dark:bg-blue-300 text-white">
            11109757
          </span>
        </div>
        <div class="flex mt-4">
